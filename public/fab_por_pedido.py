...
worksheet.merge_range('B3:F3', 'RESULTADO DE VENTAS POR FABRICACION POR MARCA', negro_s)
...
for i in range(len(marcas)):
    marcas_id=marcas['id'].values[i]
    pxv=pedidos.loc[pedidos['marca']==marcas_id] 
...
worksheet_charts.merge_range('B3:F3', 'RESULTADO DE VENTAS POR FABRICACION', negro_s)
