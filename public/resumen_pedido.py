...
worksheet.merge_range('E6:F6', 'Cliente', blue_header_format)
worksheet.write('E7', 'Clave', blue_header_format)
worksheet.write('F7', 'Nombre Corto', blue_header_format)

worksheet.merge_range('G6:G7', 'Moneda', blue_header_format)
worksheet.merge_range('H6:H7', 'TC', blue_header_format)
worksheet.merge_range('I6:I7', '', blue_header_format)
