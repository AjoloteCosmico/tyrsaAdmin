...
for i in range(0,len(pedidos)):
   ...
   if(cobros.loc[cobros['order_id']==pedidos['id'].values[i],'amount'].sum()<total):
...
worksheet.write_formula('O'+str(trow),  '{=SUM(P9:P'+str(trow-1)+')}', blue_content_bold_dll)
