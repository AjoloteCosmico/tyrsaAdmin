...
<div class="container px-4 mx-auto">
             <table>
                    <tr>
                    <td>
                            <a href="<?php echo e(route('reports.generate',[1,'dgi_resumen_ejecutivos',0])); ?>">
                            ...
                            <td>
                            <a href="<?php echo e(route('reports.generate',[1,'dgi_resumen_ejecutivos',1])); ?>">
                ...
                <table class="table text-xs font-medium table-striped text.center"  id="example4" style="table, th, td { border: 1px solid white;}">
                    ...
                    <?php $__currentLoopData = $Cobros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cobro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       ...
                       ?>
                    <tr>
                        <td>$<?php echo e(number_format(($cobro->amount/1.16)* $this_comissions->sum('percentage'),2)); ?></td>
                    ...
                    <tr>
                       ...
                       <th></th>
                       <?php $__currentLoopData = $socios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <th>$<?php echo e(number_format(($Comisiones->where('seller_id',$row->id)->sum('percentage')/1.16)*$Cobros->sum('amount'),2)); ?> </th>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tr>
                    <tr>
                        <th></th>
                    ...
                    <tr>
                        ...
                        <th>DGI</th>
                        <?php $__currentLoopData = $socios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <td>$<?php echo e(number_format($Cobros->where('seller_id',$row->id)->sum('amount')/1.16,2)); ?> </td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <th></th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th></th>
                        <th></th>
                        <th colspan="<?php echo e($socios->count()); ?>">$ <?php echo e(number_format($Cobros->sum('amount')/1.16,2)); ?> </th>
...
</div><?php /**PATH C:\xampp\htdocs\admintyrsa2\tyrsaAdmin\resources\views/reportes/dgi_resumen_ejecutivos.blade.php ENDPATH**/ ?>