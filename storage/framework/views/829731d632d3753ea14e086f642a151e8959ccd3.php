...
<?php $__env->startSection('content_header'); ?>
    <h1 class="font-bold"> <i class="fas fa-clipboard-check"></i>&nbsp; RESULTADO DE PROSPECTOS MENSUALES POR MEDIO</h1>
...
<?php $__env->startSection('content'); ?>     <div class="container-flex m-1 bg-gray-300 shadow-lg rounded-lg">
 ...
 <div style="text-transform: lowercase;"> info@tyrsa.com.mx <b> <a href="https://www.tyrsa.com.mx"> www.tyrsa.com.mx</a> </b></div>     <br>
                   ...
                   <h5 class="text-lg text-center text-bold">RESULTADO DE PROSPECTOS MENSUALES POR MEDIO </h5>
  ...
  <button id="btn-graficos" class="boton" onclick="mostrar('graficos', this)">Gráficos</button>
               ...
               <tr class="text-center">
                ...
                <tr>
                    <td><?php echo e($medio->description); ?></td>
                    <?php for($i=1;$i<=12;$i++): ?>
                      
                        <td><?php echo e($InternalOrders->where('medio_id',$medio->id)->where('date','>=',$Year.'-'.str_pad($i, 2, '0', STR_PAD_LEFT).'-01')->where('date','<=',$Year.'-'.str_pad($i, 2, '0', STR_PAD_LEFT).'-31')->count()); ?>  </td>
                        
                    <?php endfor; ?>
                    
                    <td class="text-nowrap" ><?php echo e($InternalOrders->where('medio_id',$medio->id)->count()); ?></td>
                    <td class="text-nowrap" > <?php echo e(number_format(divide(100*$InternalOrders->where('medio_id',$medio->id)->count(),$InternalOrders->count(),1))); ?> %</td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\admintyrsa2\tyrsaAdmin\resources\views/reportes/medios.blade.php ENDPATH**/ ?>