<form action="<?php echo e(route('guardar_comissions')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
                                    ...
                                    <table class="table table-striped text-md font-medium" >
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td><a href="<?php echo e(route('edit_temp_comissions', $c->id)); ?> " class="btn btn-green">
                                                        <button type = "button" class="btn btn-green "> <i class="fas fa-edit"></i> </button>
                                                   </a></td>
                                                   <td><a href="<?php echo e(route('delete_temp_comissions', $c->id)); ?> " class="btn btn-red">
                                    ...
                                    </div><?php /**PATH C:\xampp\htdocs\admintyrsa2\tyrsaAdmin\resources\views/internal_orders/asignar_dgi.blade.php ENDPATH**/ ?>