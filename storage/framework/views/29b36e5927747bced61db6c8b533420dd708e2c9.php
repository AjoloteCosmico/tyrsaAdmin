...
<?php $__env->startSection('title', 'Contraportada'); ?>
...
<div class="container-flex m-1 bg-gray-300 shadow-lg rounded-lg">
  ...
  <?php $__currentLoopData = $InternalOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td> <?php echo e($row->invoice); ?></td>
                                ...
                                <td>
                                <a href="<?php echo e(route('reports.generate',[$row->id,'contraportada',0])); ?>">
                                  <button class="button"> <span class="badge badge-success">Excel &nbsp; <i class="fa fa-file-excel-o fa-lg" aria-hidden="true"></i></span> </button>
                                  </a>  
                               </td>
                               
                               <td>
                               <a href="<?php echo e(route('reports.generate',[$row->id,'contraportada',1])); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\admintyrsa2\tyrsaAdmin\resources\views/reportes/contraportada.blade.php ENDPATH**/ ?>