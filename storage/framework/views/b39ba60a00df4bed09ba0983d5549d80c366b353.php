...
<?php $__env->startSection('content_header'); ?>
    ...
    <h1 class="font-bold"><i class="fas fa-people-roof"></i>&nbsp; MARCAS</h1>
    ...
    <div class="container-flex m-1 bg-gray-300 shadow-lg rounded-lg">
        <div class="row p-3 m-2 rounded-lg shadow-xl bg-white">
            <div class="col-sm-12 text-right">
                ...
                <a href="<?php echo e(route('marcas.create')); ?>" class="btn btn-green">
                            ...
                            <td class="w-20">
                                <div class="row">
                                    <div class="col-6 text-center w-10">
                                        ...
                                        <a href="<?php echo e(route('marcas.edit', $row->id)); ?>">
                                    ...
                                    <div class="col-6 text-center w-10">
                                        ...
                                        <form class="DeleteReg" action="<?php echo e(route('marcas.destroy', $row->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\admintyrsa2\tyrsaAdmin\resources\views/admin/marcas/index.blade.php ENDPATH**/ ?>