...
<?php endif; ?>
 ...
 <div style="text-transform: lowercase;"> info@tyrsa.com.mx www.tyrsa.com.mx</div>     <br>
                    ...
                    <table>
                      ...
                      <td> <div class="badge badge-primary badge-outlined"> <?php echo e($Factura->facture); ?></div></td>
                      <td> &nbsp; &nbsp;<br>&nbsp;&nbsp; </td>
                      <td> <div class="badge badge-danger badge-outlined">Fecha: </div></td>
                      <td> <div class="badge badge-danger badge-outlined"><?php echo e($Factura->date); ?></div></td>
    ...
    <table>
      ...
      <td > <div class="badge badge-primary badge-outlined"> <?php echo e($Coins->symbol); ?> <?php echo e(number_format($Factura->tc,2)); ?>  </div></td>                
      ...
      <td > <div class="badge badge-primary badge-outlined"> <?php echo e($Coins->symbol); ?> <?php echo e(number_format( $Factura->amount/1.16 ,2)); ?>  </div></td>                
      ...
      <td > <div class="badge badge-primary badge-outlined"> <?php echo e($Coins->symbol); ?> <?php echo e(number_format($Factura->amount - ( $Factura->amount/1.16),2)); ?>  </div></td>                
      ...
      <td > <div class="badge badge-primary badge-outlined"> <?php echo e($Coins->symbol); ?> <?php echo e(number_format($Factura->amount,2)); ?>  </div></td>                
...
<?php /**PATH C:\xampp\htdocs\admintyrsa2\tyrsaAdmin\resources\views/reportes/factura_pdf.blade.php ENDPATH**/ ?>