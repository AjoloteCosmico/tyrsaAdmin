...
<?php endif; ?>
 ...
 <div style="text-transform: lowercase;"> info@tyrsa.com.mx www.tyrsa.com.mx</div>     <br>
                    ...
                    <table>
                      ...
                      <td> <div class="badge badge-primary badge-outlined"> <?php echo e($Nota->credit_note); ?></div></td>
                      <td> &nbsp; &nbsp;<br>&nbsp;&nbsp; </td>
                      <td> <div class="badge badge-danger badge-outlined">Fecha: </div></td>
                      <td> <div class="badge badge-danger badge-outlined"><?php echo e($Nota->date); ?></div></td>
    ...
    <table>
      ...
      <tr>
      <td> <div class="badge badge-danger badge-outlined">Nota de Credito: </div></td>
      <td colspan="3"> <div class="badge badge-primary badge-outlined"><?php echo e($Nota->credit_note); ?> </div></td>                
      </tr><tr>
      ...
      <td > <div class="badge badge-primary badge-outlined"> <?php echo e($Coins->symbol); ?> <?php echo e(number_format($Coins->exchange_sell,2)); ?>  </div></td>                
      ...
      <td > <div class="badge badge-primary badge-outlined"> <?php echo e($Coins->symbol); ?> <?php echo e(number_format( $Nota->amount/1.16 ,2)); ?>  </div></td>                
      ...
      <td > <div class="badge badge-primary badge-outlined"> <?php echo e($Coins->symbol); ?> <?php echo e(number_format($Nota->amount - ( $Nota->amount/1.16),2)); ?>  </div></td>                
      ...
      <td > <div class="badge badge-primary badge-outlined"> <?php echo e($Coins->symbol); ?> <?php echo e(number_format($Nota->amount,2)); ?>  </div></td>  
      ...
      <?php $__currentLoopData = $Linked_factures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
      <td > <div class="badge badge-primary badge-outlined"> <?php echo e($f->facture); ?> </div></td>                
      <td > <div class="badge badge-primary badge-outlined"> <?php echo e($f->date); ?>   </div></td>                
      <td > <div class="badge badge-primary badge-outlined"> <?php echo e($Coins->symbol); ?> <?php echo e(number_format( $f->amount ,2)); ?>  </div></td>                
...
<?php /**PATH C:\xampp\htdocs\admintyrsa2\tyrsaAdmin\resources\views/reportes/nota_pdf.blade.php ENDPATH**/ ?>