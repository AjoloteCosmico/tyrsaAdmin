        ...
        <div class="row p-3 m-2 rounded-lg shadow-xl bg-white">
            ...
            <div class="col-sm-12 table-responsive">
                <table class="table tablefamilies table-striped text-xs font-medium">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $Families; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="text-center">
                            ...
                            <td class="w-20">
                                <div class="row">
                                    <div class="col-6 text-center w-10">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('EDITAR FAMILIAS')): ?>
                                        <a href="<?php echo e(route('families.edit', $row->id)); ?>">
                                        <button class="btn btn-blue">
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\admintyrsa2\tyrsaAdmin\resources\views/admin/families/index.blade.php ENDPATH**/ ?>