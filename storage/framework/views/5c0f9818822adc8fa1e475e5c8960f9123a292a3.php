...
<?php $__env->startSection('content'); ?>
    <div class="container bg-gray-300 shadow-lg rounded-lg">
        ...
        <?php echo Form::open(['method'=>'PUT','route'=>['roles.update',$role->id]]); ?>
...
<?php endif; ?>
                    <?php echo Form::text('name',$role->name, ['class'=>'inputjet w-full text-xs uppercase']); ?>
...
<?php endif; ?>
                    ...
                    <?php $__currentLoopData = $Categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-4 gap-3 text-sm font-bold">
                            <?php echo Form::checkbox('permission[]', $row->id, in_array($row->id, $rolePermissions) ? true : false, ['class'=>'input-jet']); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 gap-3 text-sm">
                            <?php
                                $count = 0;
                            ?>
                            <?php $__currentLoopData = $Confidencialidad; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo Form::checkbox('permission[]', $row->id, in_array($row->id, $rolePermissions) ? true : false, ['class'=>'input-jet']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\admintyrsa2\tyrsaAdmin\resources\views/admin/roles/show.blade.php ENDPATH**/ ?>