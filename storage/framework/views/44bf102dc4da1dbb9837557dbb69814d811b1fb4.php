 ...
 <div style="text-transform: lowercase;"> info@tyrsa.com.mx <b> <a href="https://www.tyrsa.com.mx"> www.tyrsa.com.mx</a> </b></div>     <br>
  ...
  <button id="btn-graficos" class="boton" onclick="mostrar('graficos', this)">Gráficos</button>
               ...
               <tr class="text-center">
                ...
                <tr>
                    <td><?php echo e($producto->family); ?></td>
                    <?php for($i=1;$i<=12;$i++): ?>
                      <td class="text-nowrap" >  <?php echo e($Items->where('family',$producto->family)->where('date','>=',$Year.'-'.str_pad($i, 2, '0', STR_PAD_LEFT).'-01')->where('date','<=',$Year.'-'.str_pad($i, 2, '0', STR_PAD_LEFT).'-31')->count()); ?>  </td>
                        
                    <?php endfor; ?>
                      <td class="text-nowrap" > <?php echo e($Items->where('family',$producto->family)->count()); ?></td>
                      <td class="text-nowrap" ><?php echo e(number_format(100*$Items->where('family',$producto->family)->count()/$Items->count(),1)); ?> %</td>
                ...
                <tr>
                    ...
                    <?php for($i=1;$i<=12;$i++): ?>
                        ...
                        <th><?php echo e($Items->where('date','>=',$Year.'-'.str_pad($i, 2, '0', STR_PAD_LEFT).'-01')->where('date','<=',$Year.'-'.str_pad($i, 2, '0', STR_PAD_LEFT).'-31')->count()); ?>  </th>
                    
                      
                    <?php endfor; ?>
                      <th><?php echo e($Items->count()); ?> </th>
                ...
                <tr>
                    ...
                    <?php for($i=1;$i<=12;$i++): ?>
                      ...
                      <td><?php echo e(number_format(100*$Items->where('date','>=',$Year.'-'.str_pad($i, 2, '0', STR_PAD_LEFT).'-01')->where('date','<=',$Year.'-'.str_pad($i, 2, '0', STR_PAD_LEFT).'-31')->count()/$Items->count(),1)); ?> %</td>
...
<script src="<?php echo e($FabChart->cdn()); ?>"></script>

<?php echo e($FabChart->script()); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\admintyrsa2\tyrsaAdmin\resources\views/reportes/ventas_fabricacion.blade.php ENDPATH**/ ?>