...
<a href="<?php echo e($dashboard_url); ?>"
    ...
    <img src="<?php echo e(asset(config('adminlte.logo_img', 'vendor/adminlte/dist/img/TyrsaLogo.png'))); ?>"
         alt="<?php echo e(config('adminlte.logo_img_alt', 'TYRSA')); ?>"
    ...
    <span class="brand-text font-weight-light <?php echo e(config('adminlte.classes_brand_text')); ?>">
        <?php echo config('adminlte.logo', '<b>TYRSAWES-</b>ADMIN'); ?>

    </span>

</a>
<?php /**PATH C:\xampp\htdocs\admintyrsa2\tyrsaAdmin\vendor\jeroennoten\laravel-adminlte\src/../resources/views/partials/common/brand-logo-xs.blade.php ENDPATH**/ ?>