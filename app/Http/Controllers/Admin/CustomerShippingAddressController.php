...
class CustomerShippingAddressController extends Controller
{
    ...
    public function edit($id,$temp_order_id,$order_id=0)
    {
        $CustomerShippingAddresses=CustomerShippingAddress::find($id);
        return view('admin.customer_shipping_addresses.show',compact(
            'CustomerShippingAddresses','temp_order_id','order_id'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate($rules, $messages);
            ...
            $Customers_Shipping_Addresses=CustomerShippingAddress::find($id);
