                    ...
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-jet-input type="number" step="0.01" name="unit_price" id="sniva" style="background-color :#9A9A9A;" class="form-control just-number price-format-input" class="w-full text-xs" disabled/>
                                        <x-jet-input-error for='unit_price' />
                                    </div>
                                    <div class="form-group">
                                        <x-jet-label value=" IVA" />
                                        <x-jet-input type="number" step="0.01" name="unit_price" id="iva" style="background-color :#9A9A9A;" class="form-control just-number price-format-input" class="w-full text-xs" disabled/>
                                        <x-jet-input-error for='unit_price' />
                                    </div>
                                    <div class="form-group">
...
@if(session('error')=='repetido')
<script>
    Swal.fire({
        icon: 'error',
        title: '¡Error!',
        text: 'Ya existe una nota de un tipo diferente para esta orden interna. Por favor, revise las notas existentes antes de crear una nueva.',
    });
</script>
@endif
<script>
