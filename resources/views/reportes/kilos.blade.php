               ...
               <tr class="text-center">
                ...
                <tr>
                    ...
                    @for($i=1;$i<=12;$i++)
                        ...
                        <td class="text-nowrap" > {{number_format($InternalOrders->where('seller_id',$seller->id)->where('date','>=',$Year.'-'.str_pad($i, 2, '0', STR_PAD_LEFT).'-01')->where('date','<=',$Year.'-'.str_pad($i, 2, '0', STR_PAD_LEFT).'-31')->sum('kilos'),2)}}  </td>
                        
                    @endfor
                    
                      <td class="text-nowrap" >  {{number_format($InternalOrders->where('seller_id',$seller->id)->sum('kilos'),2)}}</td>
                      <td class="text-nowrap" >{{number_format(100*$InternalOrders->where('seller_id',$seller->id)->sum('kilos')/$InternalOrders->sum('kilos'),1)}} %</td>
                ...
                <tr>
                    ...
                    @for($i=1;$i<=12;$i++)
                        ...
                        <th> {{number_format($InternalOrders->where('date','>=',$Year.'-'.str_pad($i, 2, '0', STR_PAD_LEFT).'-01')->where('date','<=',$Year.'-'.str_pad($i, 2, '0', STR_PAD_LEFT).'-31')->sum('kilos'),2)}}  </th>
                    
                    @endfor 
                      <th>  {{number_format($InternalOrders->sum('kilos'),2)}} </th>
                ...
                <tr>
                    <td></td>
                    @for($i=1;$i<=12;$i++)  
                      <td>{{number_format(100*$InternalOrders->where('date','>=',$Year.'-'.str_pad($i, 2, '0', STR_PAD_LEFT).'-01')->where('date','<=',$Year.'-'.str_pad($i, 2, '0', STR_PAD_LEFT).'-31')->sum('kilos')/$InternalOrders->sum('kilos'),1)}} %</td>
