...
@section('title', 'RANGO DE VENTAS POR PEDIDO INTERNO')

@section('content_header')
    <h1 class="font-bold"> <i class="fas fa-clipboard-check"></i>&nbsp; REPORTE DE RANGO DE VENTAS POR PEDIDO INTERNO</h1>
@stop
...
@section('content')     <div class="container-flex m-1 bg-gray-300 shadow-lg rounded-lg">
 ...
 <div style="text-transform: lowercase;"> info@tyrsa.com.mx <b> <a href="https://www.tyrsa.com.mx"> www.tyrsa.com.mx</a> </b></div>     <br>
            ...
            <h5 class="text-lg text-center text-bold">RANGO DE VENTAS POR PEDIDO INTERNO</h5>
            <br>
            <div >
                <table>
                    <tr>
                    <td>
                            <a href="{{route('reports.generate',[1,'rango_ventas_pi',0])}}">
                                  <button class="button"> <span class="badge badge-success">Excel &nbsp; <i class="fa fa-file-excel-o fa-lg" aria-hidden="true"></i></span> </button>
                                  </a>  
                               
                            </td>
                            <td>
                            <a href="{{route('reports.generate',[1,'rango_ventas_pi',1])}}">
  ...
  <button id="btn-graficos" class="boton" onclick="mostrar('graficos', this)">Gráficos</button>
                ...
                @php 
                  $TargetPedidos=$Pedidos->where('total','>=',$rango[0]*1000)->where('total','<=',$rango[1]*1000);
                  @endphp
               ...
               <tr>
                ...
                <tbody>
                @foreach($TargetPedidos as $pedido)
                ...
                <tfoot>
                  <tr>
                    ...
                    <th> $ {{number_format($TargetPedidos->sum('total'),2 )}}</th>
                  </tr>
                </tfoot>
               ...
               @foreach($Rangos as $rango)
                ...
                <tr>  
                  ...
                  <td>{{number_format($TargetPedidos->sum('total')*100/$Pedidos->sum('total'),2)}} %</td>
                  </tr>
                  @endif
               @endforeach
               </tbody>
                  ...
                  <td>
                    <table>
                      ...
                      <tr>
                        ...
                        <td>$ {{number_format($Pedidos->sum('total'),2) }}</td>
                      </tr>
                    </table>
                  </td>
                </tr>
