               ...
               <tr class="text-center">
                ...
                <tr>
                    ...
                    @for($i=1;$i<=12;$i++)
                        ...
                        <td>{{$InternalOrders->where('medio_id',$medio->id)->where('date','>=',$Year.'-'.str_pad($i, 2, '0', STR_PAD_LEFT).'-01')->where('date','<=',$Year.'-'.str_pad($i, 2, '0', STR_PAD_LEFT).'-31')->count()}}  </td>
                        
                    @endfor
                    
                    <td class="text-nowrap" >{{$InternalOrders->where('medio_id',$medio->id)->count()}}</td>
                    <td class="text-nowrap" > {{number_format(divide(100*$InternalOrders->where('medio_id',$medio->id)->count(),$InternalOrders->count(),1))}} %</td>
