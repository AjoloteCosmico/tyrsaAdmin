...
.badge.badge-outlined.badge-info {
 ...
 <div style="text-transform: lowercase;"> info@tyrsa.com.mx www.tyrsa.com.mx</div>     <br>
                    ...
                    <table>
                      ...
                      <td> <div class="badge badge-primary badge-outlined"> {{$Factura->facture}}</div></td>
                      <td> &nbsp; &nbsp;<br>&nbsp;&nbsp; </td>
                      <td> <div class="badge badge-danger badge-outlined">Fecha: </div></td>
                      <td> <div class="badge badge-danger badge-outlined">{{ $Factura->date}}</div></td>
    ...
    <table>
      ...
      <td > <div class="badge badge-primary badge-outlined"> {{ $Coins->symbol}} {{ number_format($Factura->tc,2)}}  </div></td>                
      ...
      <td > <div class="badge badge-primary badge-outlined"> {{ $Coins->symbol}} {{ number_format( $Factura->amount/1.16 ,2)}}  </div></td>                
      ...
      <td > <div class="badge badge-primary badge-outlined"> {{ $Coins->symbol}} {{ number_format($Factura->amount - ( $Factura->amount/1.16),2)}}  </div></td>                
      ...
      <td > <div class="badge badge-primary badge-outlined"> {{ $Coins->symbol}} {{ number_format($Factura->amount,2)}}  </div></td>                
