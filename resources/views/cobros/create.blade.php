                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @else 
                                    <div class="form-group">
                                        <x-jet-label value="* COMPORBANTE DE INGRESO" />
                                        <x-jet-input type="text"  name="comp" id="comp" class="form-control  w-full text-xs" value="{{$ncomp}}" readonly  />
                                        <x-jet-input-error for='comp' />
                                    </div>
                               @endcan 
                                    <!-- <div class="form-group">
...
th     { background:#eee; }" >
                                   ...
                                   <br><br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-jet-input type="number" step="0.0001" name="tc" id="tc" class="form-control just-number  w-full text-xs" />
