    ...
    <div class="row rounded-b-lg rounded-t-none mb-4 shadow-xl bg-gray-300">
        <div class="row p-4">
            <div class="col-sm-12 col-xs-12 shadow rounded-xl p4">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('store_comisiones_pos') }}" id="comisiones-form" method="POST">
                            @csrf
                                    ...
                                    @if(isset($DGI) && $DGI->count() > 0)
                                        @foreach($DGI as $dgi)
                                            <div class="row align-items-center mb-2 dgi-row">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="number" name="comision[]" class="form-capture comision-input" value="{{ $dgi->comision }}" min="0.01" step="0.01" style="width:70%"/> &nbsp; %
                                                </div>
                                                <div class="col-md-2">
