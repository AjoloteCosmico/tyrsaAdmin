...
<style>
  ...
  th {
    ...
    background-color:rgb(8, 32, 85)  !important; /* O agrega un fondo oscuro si lo necesitas */
  }
...
<div class="container-flex m-1 bg-gray-300 shadow-lg rounded-lg" id='content'>
            ...
            <div class="row p-4">
                ...
                <table  style="border: none !important; border-collapse: collapse;" width="100%">
                        <tr style="border: none !important; border-collapse: collapse;">
                            <td style="border: none !important; border-collapse: collapse;"> &nbsp; &nbsp; &nbsp;</td>
                            <td style="border: none !important; border-collapse: collapse;">
                                <div class="contaier">
                        
                                                <img  src="{{ $base64 }}"  alt="TYRSA"  style="align-self: left;"> </div></td>
                                        </td>
                                 
                            <td rowspan="2" style="border: none !important; border-collapse: collapse;">
                        <br>
 ...
 <div style="text-transform: lowercase;"> info@tyrsa.com.mx <b> <a href="https://www.tyrsa.com.mx"> www.tyrsa.com.mx</a> </b>    <br>
                        ...
                        <td  colspan="2"class="text-lg " style="color: red;  width:23%; border: none !important; border-collapse: collapse;">{{ $CompanyProfiles->company}}
                        </td>
                        <tr>              
                        </tr>
