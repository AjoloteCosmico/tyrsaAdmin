                    ...
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-jet-input type="number" step="0.01" min="0" name="amount" id="import" class="form-control just-number price-format-input" class="w-full text-xs" value="{{round($Facture->amount,2)}}"/>
                                        <x-jet-input-error for='unit_price' />
                                    </div>
