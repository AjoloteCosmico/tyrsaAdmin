    ...
    <div class="container-flex m-1 bg-gray-300 shadow-lg rounded-lg">
        <div class="row p-3 m-2 rounded-lg shadow-xl bg-white">
            <div class="col-sm-12 text-right">
                @can('CREAR CLIENTES')
                <a href="{{ route('customers.validar_rfc')}}" class="btn btn-green" style="background-color: rgb(22,163,74);color: white;">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @else  
                                        ...
                                        <button type="button" class="btn btn-blue  " style="background-color: rgb(37 ,99 ,235 );color: white; font-size: 0.5vw;">
                            ...
                            <td class="w-15">
                                <div class="row">
                                    <div class="col-6 text-center w-10">
                                        ...
                                        <button type="submit" class="  " style="background-color: rgb(37 ,99 ,235 );color: white;"">
